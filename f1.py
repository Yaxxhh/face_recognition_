...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        matches = [face_recognition.compare_faces(person_encodings, face_encoding,tolerance=0.45) for person_encodings in known_face_encodings]
        name = "Unknown"
        ...
        if name=='Yash':
            ...
            cv2.putText(frame, "Thief", (left + 6, bottom - 6), font, 0.5, (255, 255, 255), 1)
        elif name=='Soni':
            cv2.rectangle(frame, (left, top), (right, bottom), (255, 0, 0), 2)
            cv2.putText(frame, "Detective", (left + 6, bottom - 6), font, 0.5, (255, 255, 255), 1)
